---
name: tiptap-skill
description: TipTap & ProseMirror architecture rules for the Tykwriter editor. Use whenever working on TiptapEditor.tsx, decorations, marks, custom extensions, or editor commands.
---
