...
- If your code implementation requires a new environment variable (e.g., for an AI provider key, Dokploy config, data base url, etc...), you MUST add the key and a dummy value to `.env.example`.
