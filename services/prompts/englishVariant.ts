 ...
 * 'auto' (défaut) et 'fr' correspondent tous deux à la variante 'auto' : la
 * détection automatique de la langue du texte reste active dans tous les cas,
 * seule la convention orthographique anglaise change. L'option 'auto' affiche
 * en plus la langue détectée par le modèle dans le libellé du sélecteur.
 */
export type WritingLanguage = 'auto' | 'fr' | 'en-US' | 'en-GB';

export const WRITING_LANGUAGES: readonly WritingLanguage[] = ['auto', 'fr', 'en-US', 'en-GB'];
